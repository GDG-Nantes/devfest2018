...
const getFunMessage = (diff) => {
  switch (true) {
    case diff >= 300:
      return "Alors c'est normal qu'il reste des places, c'est le début ⛱";
    case diff >= 200:
...
const formatForSlackCommand = (data) => {
  ...
  console.log(`{
    ...
    "text": "Tickets achetés: ${data[0]} / ${data[1]}. Il reste ${diff} places. -- Early: ${data[2]} / ${data[3]} : reste ${diffEA} places",
    "attachments": [
        {
